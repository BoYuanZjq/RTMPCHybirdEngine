...
Pod::Spec.new do |s|
  ...
  #
   ...
   s.source_files  = 'RTMPCHybirdEngine','RTMPCHybirdEngine/RTMPCHybirdEngine/*.h'
  # s.exclude_files = "Classes/Exclude"
   s.vendored_frameworks  ='RTMPCHybirdEngine', 'RTMPCHybirdEngine/RTMPCHybirdEngine/*.framework'
